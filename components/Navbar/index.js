      ...
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav ms-auto mr-auto mb-2 mb-lg-0">
            ...
            <li className="nav-item">
              <Link href="https://postofficebahamas.com/">
            ...
            <li className="nav-item">
              <Link href="https://www.roadtraffic.gov.bs/">
                <a target="_blank" className="nav-link">
                  Road Traffic
                </a>
              </Link>
              ...
              <ul className="dropdown-menu shadow">
                ...
                <li>
                  <Link href="/housing-models">
                    <a className="dropdown-item">Housing Models</a>
                  </Link>
                </li>

                <li>
                  <Link href="/subdivisions">
                    <a className="dropdown-item">Subdivisions</a>
                  </Link>
                </li>
                {/* ============================= */}
